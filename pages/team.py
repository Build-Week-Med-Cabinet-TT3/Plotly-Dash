...
column2 = dbc.Col(
    [
        dcc.Markdown(
            ...
            **Rassamy "Jack" Soumphonphakdy** is a full-time data science student at Lambda School with dreams of relocating to Virginia.  [![email Jack](/assets/email_icon_3.png)](mailto:jacksoumphonphakdy@gmail.com) [![Jack's GitHub](/assets/github_icon.png)](https://github.com/rassamyjs) [![Jack's LinkedIn](/assets/linkedin_icon.png)](https://www.linkedin.com/in/elizabeth-edwards-appell-62398b15/)
